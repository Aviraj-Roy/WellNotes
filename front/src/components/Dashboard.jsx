...
import { BACKEND_URL, HF_TOKEN } from '../config';
import { usePrivy } from '@privy-io/react-auth';
import axios from 'axios';
import OwnedGroups from './made/OwnedGroups';
  ...
  return (
    <div>
      {loading ? (
        ...
        <>
          <NavBar />
          <div className="min-h-screen flex flex-col  bg-black pt-5 px-5">
            <ProfileBar />
            <div className="flex flex-col lg:flex-row pt-5 lg:mx-10 justify-center items-center">
